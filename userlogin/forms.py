...
class Login(forms.Form):
    ...
    password= forms.CharField(label="PASSWORD", validators=[loginpassword],widget=forms.PasswordInput(attrs={'class':'form-control','id':"floatingInput", 'placeholder':"strong password",'for':"floatingInput"}))